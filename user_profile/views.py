        ...
        try:
            ...
            if request.user.check_password(old_password):
                if new_password == confirm_new_password:
                    ...
                    messages.error(request,"Fialed to update password.New password does not match")
                    return redirect('profile:update_password')
            else:
                messages.error(request,"Fialed to update password.Old password does not match")
                return redirect('profile:update_password')
        except Exception as error:
